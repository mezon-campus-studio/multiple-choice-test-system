...
public class QuestionService {
    ...
    public boolean updateQuestion(Long id, Question question) {
        ...
        if (existing.isPresent()) {
            ...
            q.setDifficult(question.getDifficult());
    ...
    public int importQuestions(List<ParsedQuestionDTO> parsedQuestions) {
        ...
        for (ParsedQuestionDTO dto : parsedQuestions) {
            ...
            question.setSubjectId(dto.getSubjectId() != null ? dto.getSubjectId() : 1L);
            question.setType("MULTIPLE_CHOICE");

            Integer diffLevel = parseDifficultyLevel(dto.getDifficulty());
            question.setDifficult(diffLevel);
            ...
            if (options != null) {
                for (int i = 0; i < options.size(); i++) {
                    ...
                    answer.setDescription(options.get(i).getContent());
